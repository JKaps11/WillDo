...
import { TAG_DEFAULT_COLOR, TAG_MAX_LENGTH, TAG_MAX_WIDTH } from '@/lib/constants';
...
export function SettingsTasksTab(): ReactNode {
    ...
    const handleStartEdit = (tagId: string, title: string, color: string): void => {
                            ...
                            {tags.map((tag) => (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        editingTagId === tag.tagId ? 'bg-muted/50' : 'hover:bg-muted/30'
                                    )}
                                >
                                    {editingTagId === tag.tagId ? (
                                        <>
                                            ...
                                            <Button
                                                ...
                                                disabled={!editTitle.trim() || updateTagMutation.isPending}
                                                className="h-8 w-8"
                                            >
                                        ...
                                        <>
                                            ...
                                            <Button
                                                variant="ghost"
                                                size="icon"
                                                onClick={() => handleStartEdit(tag.tagId, tag.title, tag.color)}
                                                className="h-7 w-7"
                                            >
